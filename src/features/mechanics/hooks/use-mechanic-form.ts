...
import { createMechanicSchema, type MechanicSchema } from '@/features/mechanics/schemas/mechanic-schema';
import { mechanicsService } from '@/features/mechanics/services/mechanics-service';
import type { ApiErrorResponse } from '@/types/common';

export function useMechanicForm(mode: 'create' | 'edit' | 'view', id: string, onSuccess: () => void) {
